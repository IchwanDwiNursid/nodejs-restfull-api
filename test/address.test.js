...
describe('PUT /api/contacts/:contactId/addresses/:addressId',function () {
    ...
    it('should can update address', async() => {
        ...
        expect(result.body.data.country).toBe("indonesia");
        expect(result.body.data.postal_code).toBe("12341234");
...
describe('DELETE /api/contacts/:contactId/addresess/:addressId', function () {
    beforeEach(async () => {
        await createTestUser();
        await createTestContact();
        await createTestAddress()
...
describe('GET /api/contacts/:contactId/addresess',function () {
    beforeEach(async () => {
        await createTestUser();
        await createTestContact();
        await createTestAddress()
